                    ...
                    <div class=" row justify-content-center px-lg-5 ">
                        <div class=" col-12 col-lg-6">
                            ...
                            <div class=" card shadow rounded ">
                                <div class=" card-header fw-bold fs-4">Update Password</div>
                                ...
                                <div class=" card-body">
                                    ...
                                    <div class=" col-12 p-3 ">
                                        ...
                                        <div class=" col-12 mb-3">
                                            ...
                                            <input type="email" id="email" class="form-control" value="<?php echo $_SESSION["user"]["email"] ?>" />
                                        </div>
                                        ...
                                        <div class=" col-12 mb-0">
                                            <button class=" btn btn-success col-12 text-center fw-bold" onclick="newps();"> Submit </button>
                                        </div>
